...
export default defineComponent({
  ...
  setup() {
    ...
    const nav1Items: NavBar[] = [
      { title: 'Cá Nhân', icon: 'ic-library', slug: '/ca-nhan' },
      ...
      { title: 'Theo Dõi', icon: 'ic-feed', slug: '/theo-doi' },
    ]
    const nav2Items: NavBar[] = [
      { title: 'Nhạc Mới', icon: 'ic-mn-song', slug: '/nhac-moi' },
      { title: 'Thể Loại', icon: 'ic-mn-catalogue', slug: '/the-loai' },
      { title: 'Top 100', icon: 'ic-mn-top100', slug: '/top-100' },
      { title: 'MV', icon: 'ic-mn-mv', slug: '/mv' },
    ]
