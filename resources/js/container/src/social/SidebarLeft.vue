<template>
  <div class="social-sidebar-left active">
    <div class="social-sidebar-left-button">
      <svg
        viewBox="0 0 24 24"
        stroke="currentColor"
        stroke-width="2"
...
.social-sidebar-left {
  ...
  @media screen and (max-width: 930px) {
    &.active {
      ...
      .social-sidebar-left-button svg:first-child {
        opacity: 0;
      }
      .social-sidebar-left-button svg:last-child {
    ...
    &:not(.active) {
      width: 56px;
      overflow: hidden;
      & > *:not(.logo):not(.social-sidebar-left-button) {
        opacity: 0;
      }
      .logo {
