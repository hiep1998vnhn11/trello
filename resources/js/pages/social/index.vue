  ...
  <div>
    <div class="social-profile">
      <div class="social-profile-avatar">
        ...
        />
        <div class="social-profile-name">Quan Ha</div>
      </div>
      <img
        ...
        alt=""
        class="social-profile-cover"
      />
      <div class="social-profile-menu">
        <a class="social-profile-menu-link active">Timeline</a>
        <a class="social-profile-menu-link">About</a>
        <a class="social-profile-menu-link">Friends</a>
        <a class="social-profile-menu-link">Photos</a>
        <a class="social-profile-menu-link">More</a>
      </div>
    </div>
    <div class="timeline">
